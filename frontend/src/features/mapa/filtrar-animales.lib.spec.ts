...
describe('filtrarAnimales', () => {
  ...
  it('filtra por texto de busqueda sin distinguir mayusculas', () => {
    const animales = [
      crearAnimal({ id: 1, nombre: 'Rocky' }),
      crearAnimal({ id: 2, nombre: 'Canela' }),
    ];
  ...
  it('filtra por barrio', () => {
    const animales = [
      crearAnimal({ id: 1, barrio: 'El Poblado' }),
      crearAnimal({ id: 2, barrio: 'Las Cruces' }),
    ];
  ...
  it('filtra por comunidad', () => {
    const animales = [
      crearAnimal({ id: 1, comunidad_id: 1 }),
      crearAnimal({ id: 2, comunidad_id: 2 }),
    ];
  ...
  it('combina varios criterios a la vez', () => {
    ...
    const resultado = filtrarAnimales(animales, {
      ...criteriosBase(),
      busqueda: 'rocky',
      barrio: 'El Poblado',
    });
